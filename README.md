...
- Multiple room views (kitchen, bathroom, bedroom) for users to scroll through
- User identification features
- Enhanced visual design to reinforce domestic atmosphere: 3d scan of flat as environment, uncanny valley/early 3D graphics where the skins don't quite match the base 


## Technology Used
- P5js sketch for interface
...
3. Open `localhost:3500` in multiple browser windows
4. Type messages in one window - they will appear in all connected windows in real time
